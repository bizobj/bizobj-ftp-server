package org.bizobj.ftp.fs.mapping;
...
import org.bizobj.ftp.fs.mapping.MappingModel.FSMappingResult;
...
public class MappingNativeFileSystemFactory extends NativeFileSystemFactory {
	private static final Logger log = Logger.getLogger(MappingNativeFileSystemFactory.class);
